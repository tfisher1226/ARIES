...
public class LogEventListenerForJAXWSUnitTest extends AbstractListenerForJAXWSUnitTest {
	
	private LogEventListenerForJAXWS fixture;
	...
	protected LogEventListenerForJAXWS createFixture() throws Exception {
		fixture = new LogEventListenerForJAXWS();

...
@XmlType(name = "QueryRequestMessage", namespace = "http://bookshop2", propOrder = {
	"books"
})
@XmlRootElement(name = "queryRequestMessage", namespace = "http://bookshop2")
public class QueryRequestMessage extends AbstractMessage implements Serializable {

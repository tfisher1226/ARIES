...
@XmlType(name = "ReservationRequestMessage", namespace = "http://bookshop2", propOrder = {
	"books"
})
@XmlRootElement(name = "reservationRequestMessage", namespace = "http://bookshop2")
public class ReservationRequestMessage extends AbstractMessage implements Serializable {

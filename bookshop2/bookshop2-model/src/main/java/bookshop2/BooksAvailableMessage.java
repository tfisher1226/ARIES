...
@XmlType(name = "BooksAvailableMessage", namespace = "http://bookshop2", propOrder = {
	"books"
})
@XmlRootElement(name = "booksAvailableMessage", namespace = "http://bookshop2")
public class BooksAvailableMessage extends AbstractMessage implements Serializable {

...
CREATE TABLE `book_orders_book` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK61711BADD94CCCE1` (`order_id`),
  CONSTRAINT `FK61711BADD94CCCE1` FOREIGN KEY (`order_id`) REFERENCES `book_orders` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2015-02-28 18:52:32

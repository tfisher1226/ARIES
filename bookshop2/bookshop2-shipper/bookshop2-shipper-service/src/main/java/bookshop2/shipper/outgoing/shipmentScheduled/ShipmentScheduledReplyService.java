...
@WebServiceClient(name = "shipmentScheduledReply", targetNamespace = "http://bookshop2/shipper")
public class ShipmentScheduledReplyService extends Service {
	...
	public ShipmentScheduledReplyService(URL wsdlLocation) {
		this(wsdlLocation, new QName("http://bookshop2/shipper", "shipmentScheduledReplyService"));
	}
	...
	public ShipmentScheduledReply getPort() {
		return super.getPort(new QName("http://bookshop2/shipper", "shipmentScheduledReply"), ShipmentScheduledReply.class);
	}
	
	@WebEndpoint(name = "shipmentScheduledReply")
	public ShipmentScheduledReply getPort(WebServiceFeature... features) {
		return super.getPort(new QName("http://bookshop2/shipper", "shipmentScheduledReply"), ShipmentScheduledReply.class, features);
	}

...
public class ShipperTestWARBuilder extends AbstractArquillianWARBuilder {

	private WebArchiveBuilder builder;
	
	
	public ShipperTestWARBuilder(String fileName) {
...
//		builder.addJavaLibraryToWar("bookshop2", "bookshop2-shipper-model", "0.0.1-SNAPSHOT");
//		builder.addJavaLibraryToWar("bookshop2", "bookshop2-shipper-client", "0.0.1-SNAPSHOT");
...
//		builder.addTestLibraryToWar("bookshop2", "bookshop2-shipper-data", "0.0.1-SNAPSHOT");
		builder.addTestLibraryToWar("bookshop2", "bookshop2-shipper-service", "0.0.1-SNAPSHOT");

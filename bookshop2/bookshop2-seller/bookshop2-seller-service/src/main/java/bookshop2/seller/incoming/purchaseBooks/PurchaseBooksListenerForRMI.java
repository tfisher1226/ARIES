...
public class PurchaseBooksListenerForRMI extends AbstractRMIListener implements Remote {
	...
	public PurchaseBooksListenerForRMI() throws RemoteException {
	...
	public Object getDelegate() {
		if (purchaseBooksInterceptor == null || resetRequested)
			purchaseBooksInterceptor = BeanContext.getFromJNDI(PurchaseBooksInterceptor.class, "PurchaseBooksInterceptor");

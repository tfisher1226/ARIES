...
public class BooksAvailableListenerForRMI extends AbstractRMIListener implements Remote {
	
	private SellerContext sellerContext;
	
	private BooksAvailableInterceptor booksAvailableInterceptor;
	
	
	public BooksAvailableListenerForRMI() throws RemoteException {
	...
	public Object getDelegate() {
		if (booksAvailableInterceptor == null || resetRequested)
			booksAvailableInterceptor = BeanContext.getFromJNDI(BooksAvailableInterceptor.class, "BooksAvailableInterceptor");

...
public class BooksUnavailableListenerForJAXWSUnitTest extends AbstractListenerForJAXWSUnitTest {
	
	private BooksUnavailableListenerForJAXWS fixture;
	...
	protected BooksUnavailableListenerForJAXWS createFixture() throws Exception {
		fixture = new BooksUnavailableListenerForJAXWS();

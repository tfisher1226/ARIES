...
public class ShipmentScheduledListenerForJAXWSUnitTest extends AbstractListenerForJAXWSUnitTest {
	
	private ShipmentScheduledListenerForJAXWS fixture;
	...
	protected ShipmentScheduledListenerForJAXWS createFixture() throws Exception {
		fixture = new ShipmentScheduledListenerForJAXWS();

...
public class TestJARBuilder extends AbstractArquillianJARBuilder {

	private JavaArchiveBuilder builder;
	
	
	public TestJARBuilder(String jarName) {
		builder = createJavaArchiveBuilder(jarName); 
	}
...
//		//builder.addWarModuleToEar("bookshop2", "bookshop2-supplier-view", "0.0.1-SNAPSHOT");
		...
		builder.addTestLibraryToWar("bookshop2", "bookshop2-supplier-data", "0.0.1-SNAPSHOT");
		builder.addTestLibraryToWar("bookshop2", "bookshop2-supplier-service", "0.0.1-SNAPSHOT");

...
import org.aries.ui.JmxConfiguration;
import org.aries.ui.JmxEvent;
import org.aries.ui.JmxEventHandlerMBean;
...
import bookshop2.seller.client.orderBooks.OrderBooksClient;
...
@SessionScoped
@Named("sellerServiceManager")
public class SellerServiceManager extends AbstractInvocationManager implements Serializable {

	@Inject
	private JmxEventManager jmxEventManager;
	
	
	public SellerServiceManager() throws Exception {
		initializeOrderBooks();
		initializePurchaseBooks();
	}
	
	protected SellerInfoManager getSellerInfoManager() {
		return BeanContext.getFromSession("sellerInfoManager");
	}
	...
	public void handleOrderRequestMessageEntered() {
		SellerInfoManager manager = getSellerInfoManager();
	...
	protected Handler<OrderAcceptedMessage> createOrderAcceptedHandler() {
		return new Handler<OrderAcceptedMessage>() {
			public void handle(OrderAcceptedMessage orderAcceptedMessage) {
				jmxEventManager = BeanContext.getFromSession("jmxEventListManager");
...
//	}
	...
	protected void initializeJmxManager() throws Exception {

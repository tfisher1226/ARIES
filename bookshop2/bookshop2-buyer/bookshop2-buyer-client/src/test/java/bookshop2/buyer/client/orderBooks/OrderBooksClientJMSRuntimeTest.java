...
public class OrderBooksClientJMSRuntimeTest {

	private OrderBooksProxyForJMS fixture;

	private String destinationName = "jms/testQueue";

	private String connectionFactoryName = "jms/connectionFactory";
	...
	protected Properties getInitialContextProperties() {
		URL url = getClass().getResource("/provider/hornetq/node1-jndi-remote.properties");

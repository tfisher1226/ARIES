...
public class BuyerTestWARBuilder extends AbstractArquillianWARBuilder {

	private WebArchiveBuilder builder;
	
	
	public BuyerTestWARBuilder(String fileName) {
...
//		builder.addTestLibraryToWar("bookshop2.buyer", "bookshop2-buyer-data", "0.0.1-SNAPSHOT");
		builder.addTestLibraryToWar("bookshop2.buyer", "bookshop2-buyer-service", "0.0.1-SNAPSHOT");

...
public class BuyerTestEARBuilder extends AbstractArquillianEARBuilder {

	public static final String NAME = "bookshop2-buyer.ear";
	...
	public BuyerTestEARBuilder() {
		this(NAME);
	}
	
	public BuyerTestEARBuilder(String earName) {
	...
	public EnterpriseArchive createEAR() {
		...
		earBuilder.addEjbModuleToEar("bookshop2.buyer", "bookshop2-buyer-client", "0.0.1-SNAPSHOT");
		earBuilder.addEjbModuleToEar("bookshop2.buyer", "bookshop2-buyer-service", "0.0.1-SNAPSHOT");
		if (isIncludeWar)
			earBuilder.addWarModuleToEar("bookshop2.buyer", "bookshop2-buyer-view", "0.0.1-SNAPSHOT");
...
//		earBuilder.addJavaModuleToEar("org.aries", "tx-manager-registry", "0.0.1-SNAPSHOT");
	...
	public StringAsset getApplicationXml() {
		...
		appXmlBuilder.addEjbModule("bookshop2-buyer-client-0.0.1-SNAPSHOT.jar");
		appXmlBuilder.addEjbModule("bookshop2-buyer-service-0.0.1-SNAPSHOT.jar");
		if (isIncludeWar)
			appXmlBuilder.addWebModule("bookshop2-buyer-view-0.0.1-SNAPSHOT.war", "bookshop2-buyer");
...
//		appXmlBuilder.addJavaModule("tx-manager-registry-0.0.1-SNAPSHOT.jar");
		...
		appXmlBuilder.addEjbModule("jboss-seam-2.3.0.Final.jar");

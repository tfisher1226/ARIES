...
insert into `person_name` (id, first_name, last_name, middle_initial) values (3, 'M', 'M', '');
insert into `person_name` (id, first_name, last_name, middle_initial) values (4, 'T', 'F', '');

insert into `user` (id, name_id, user_name, password_hash, person_name_id, email_address_id, enabled) values (1, 3, 'manager', 'm', 1, 1, true);
insert into `user` (id, name_id, user_name, password_hash, person_name_id, email_address_id, enabled) values (2, 4, 'tfisher', '!Hello2u', 2, 2, true);

...
@Role(name = "mainPermissionListManager", scope = ScopeType.SESSION)
public class PermissionListManager extends AbstractTabListManager<Permission, PermissionListObject> implements Serializable {
	...
	@Observer("org.aries.removePermission")
	...
	@Observer("org.aries.cancelPermission")
...
//	@Observer("org.aries.exportPermissionList")

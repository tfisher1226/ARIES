...
public class InfosgiModelGeneratorMain extends AbstractGenerator {

	public static String FILE_NAME = "/sgiusa/infosgi-information.aries";

	public static String WORKSPACE_LOCATION = "c:/workspace/STAGING";
	

	public static void main(String[] args) throws Exception {
		InfosgiModelGeneratorMain main = new InfosgiModelGeneratorMain();
		main.generate();
	}

	protected void generate() throws Exception {
		String domain = "org.sgiusa";
		String name = "infosgi";
		String namespace = "http://www.sgiusa.org/model";

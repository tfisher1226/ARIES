...
public class AdminModelGeneratorMain extends AbstractGenerator {

	public static String FILE_NAME = "/admin/admin_model.aries";

	public static String WORKSPACE_LOCATION = "c:/workspace/STAGING";
	

	public static void main(String[] args) throws Exception {
		AdminModelGeneratorMain main = new AdminModelGeneratorMain();
		main.generate();
	}
	...
	protected void generate() throws Exception {
		...
		String name = "admin";
		String namespace = "http://www.aries.org/admin";

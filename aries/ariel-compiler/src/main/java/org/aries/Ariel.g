...
expressionDecl
	:	('new' Identifier '(' ')') -> ^(EXPR 'new' Identifier '(' ')')
...
networkDecl
	:	'network'^ Identifier networkBody
	;
...
fragment
TimeValueSuffix : ('sec' | 'min' | 'hr' | 'day' | 'wk') ;

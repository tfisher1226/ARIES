package common.tx.model.coordinator;
...
public interface CoordinatorPortType {
    ...
    public void fault(@WebParam(name = "Fault", targetNamespace = "http://schemas.xmlsoap.org/soap/envelope/", partName = "parameters") Event fault);

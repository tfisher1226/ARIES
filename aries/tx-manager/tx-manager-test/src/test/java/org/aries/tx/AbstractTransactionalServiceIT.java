...
public class AbstractTransactionalServiceIT extends AbstractIT {

	protected String propertyLocation = "../runtime/properties";
	...
	public void setUp() throws Exception {
		...
		PropertyManager.getInstance().setPropertyLocation(propertyLocation);
	...
	protected void addProxyInstance(String proxyId, Object proxyInstance, TransportType transportType) {
		proxyLocator.add(proxyId, proxyInstance, transportType.name());
	}
	
	protected void addProxyInstance(String proxyId, Object proxyInstance, String transportType) {
		proxyLocator.add(proxyId, proxyInstance, transportType);
	}

...
public class ServiceModuleTestControl extends DataLayerTestControl {
	...
	public ServiceModuleTestControl(TransactionTestControl transactionTestControl) {
...
//	}
	...
	public void startServices(String host, int port) throws Exception {
		//TODO startClientSide(host, port);
		//TODO startServerSide(host, port);
	}

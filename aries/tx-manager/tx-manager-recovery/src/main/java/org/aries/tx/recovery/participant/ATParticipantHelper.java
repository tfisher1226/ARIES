...
public class ATParticipantHelper {
     ...
     */
    public static byte[] getRecoveryState(boolean useSerialization, Durable2PCParticipant participant) throws Exception {
        if (useSerialization) {
    ...
    public static boolean isSerializable(Durable2PCParticipant participant) {
        return participant instanceof Serializable;
    }
}

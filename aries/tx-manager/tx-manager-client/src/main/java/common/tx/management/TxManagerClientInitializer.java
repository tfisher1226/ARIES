...
public class TxManagerClientInitializer implements Initializer, Serializable {
	...
	public void initialize() throws Exception {
        ...
        TXManagerClientSideLauncher txManagerClientSideLauncher = new TXManagerClientSideLauncher();
        txManagerClientSideLauncher.register(hostName, httpPort);

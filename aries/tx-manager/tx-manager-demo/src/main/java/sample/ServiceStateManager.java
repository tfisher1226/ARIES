...
import common.tx.state.ServiceStateConstants;
 ...
 * </ul>
 */
public abstract class ServiceStateManager<T extends ServiceState> implements ParticipantManager, ServiceStateConstants {
	/**

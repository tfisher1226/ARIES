 ...
 * @author tfisher
 */
public class BeanRegistryImpl extends AbstractCachePeer {
	...
	private static String CACHE_NAME = "BeanRegistry";
	...
	public static ProcessKey getProcessKey(String name, String version, String correlationId) {
		return ProcessStateUtil.createProcessKey(name, version, correlationId);
	}

	
	public ProcessState getProcessState(String name, String version, String correlationId) {
		synchronized (mutex) {
			try {
				//acquireReadLock();

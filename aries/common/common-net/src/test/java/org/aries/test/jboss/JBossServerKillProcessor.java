...
public class JBossServerKillProcessor implements ServerKillProcessor {

    private final Logger log = Logger.getLogger(JBossServerKillProcessor.class.getName());
    ...
    //@Override
	public void killNOTYET(Container container) throws Exception {

...
public class TransientAnnotationReader extends AbstractInlineAnnotationReaderImpl<Type, Class, Field, Method>
	...
	public static Collection<String> getPackagesToLoad() {
		List<String> list = new ArrayList<String>();
		//list.add("com.sun.xml.internal.bind.api");
		//list.add("com.sun.xml.bind.v2.model.annotation");
		return list;
	}

	public static Collection<Class<?>> getClasses() {
		List<Class<?>> classes = new ArrayList<Class<?>>();
		classes.add(AbstractInlineAnnotationReaderImpl.class);
		classes.add(Locatable.class);
		classes.add(RuntimeAnnotationReader.class);
		classes.add(RuntimeInlineAnnotationReader.class);
		return classes;
	}

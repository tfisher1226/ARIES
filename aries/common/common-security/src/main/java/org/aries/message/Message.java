 ...
 *         &lt;element name="header" type="{http://www.aries.org/message/0.0.1}Header" minOccurs="0"/>
 *         &lt;element name="parts">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
    ...
    implements Serializable
{
	...
	public <T> T removePart(String key) {
		...
		if (value != null) {
			...
			getParts2().getEntries().remove(entry);
		}
		return value;
	}
	...
	public void addPart(String key, Object value) {
		...
		entry.setKey(key);
		entry.setValue(value);
		getParts2().getEntries().add(entry);
	}
	
    
	public Parts getParts2() {
	...
	public Map<String, Object> getMap() {
		...
		List<Message.Parts.Entry> list = getParts2().getEntries();
		Iterator<Message.Parts.Entry> iterator = list.iterator();
		while (iterator.hasNext()) {
			Message.Parts.Entry entry = (Message.Parts.Entry) iterator.next();
	...
	public String toString() {
		...
		return "Message:"+getParts2().hashCode();
	}

...
@ApplicationScoped
@Named("propertyValidator")
public class PropertyValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Property == false)
				throwError("Unexpected value: "+value);
			Property property = (Property) value;
			if (PropertyUtil.validate(property) == false) {

...
public class DomainValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Domain == false)
				throwError("Unexpected value: "+value);
			Domain domain = (Domain) value;
			if (DomainUtil.validate(domain) == false) {

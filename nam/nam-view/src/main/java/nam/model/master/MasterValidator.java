...
@ApplicationScoped
@Named("masterValidator")
public class MasterValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Master == false)
				throwError("Unexpected value: "+value);
			Master master = (Master) value;
			if (MasterUtil.validate(master) == false) {

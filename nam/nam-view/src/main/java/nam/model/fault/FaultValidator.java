...
@ApplicationScoped
@Named("faultValidator")
public class FaultValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Fault == false)
				throwError("Unexpected value: "+value);
			Fault fault = (Fault) value;
			if (FaultUtil.validate(fault) == false) {

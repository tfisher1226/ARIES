...
@SessionScoped
@Named("persistenceModuleListManager")
public class ModuleListManager_Persistence extends AbstractDomainListManager<Module, ModuleListObject> implements Serializable {
	...
	protected Collection<Module> createRecordList() {
		try {
			Collection<Module> moduleList = moduleDataManager.getModuleList(ModuleType.DATA);
			if (moduleList != null)
				return moduleList;
			return recordList;
		} catch (Exception e) {

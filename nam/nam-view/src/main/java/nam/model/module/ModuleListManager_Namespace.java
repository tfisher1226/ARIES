...
@SessionScoped
@Named("namespaceModuleListManager")
public class ModuleListManager_Namespace extends AbstractDomainListManager<Module, ModuleListObject> implements Serializable {
	...
	protected Collection<Module> createRecordList() {
		try {
			Collection<Module> moduleList = moduleDataManager.getModuleList(ModuleType.MODEL);
			if (moduleList != null)
				return moduleList;
			return recordList;
		} catch (Exception e) {

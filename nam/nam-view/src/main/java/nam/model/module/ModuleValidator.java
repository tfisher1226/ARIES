...
@ApplicationScoped
@Named("moduleValidator")
public class ModuleValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Module == false)
				throwError("Unexpected value: "+value);
			Module module = (Module) value;
			if (ModuleUtil.validate(module) == false) {

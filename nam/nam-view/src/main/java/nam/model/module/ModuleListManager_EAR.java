...
@SessionScoped
@Named("earModuleListManager")
public class ModuleListManager_EAR extends AbstractDomainListManager<Module, ModuleListObject> implements Serializable {
	...
	protected Collection<Module> createRecordList() {
		try {
			Collection<Module> moduleList = moduleDataManager.getModuleList(ModuleType.EAR);
			if (moduleList != null)
				return moduleList;
			return recordList;
		} catch (Exception e) {

...
@SessionScoped
@Named("clientModuleListManager")
public class ModuleListManager_Client extends AbstractDomainListManager<Module, ModuleListObject> implements Serializable {
	...
	protected Collection<Module> createRecordList() {
		try {
			Collection<Module> moduleList = moduleDataManager.getModuleList(ModuleType.CLIENT);
			if (moduleList != null)
				return moduleList;
			return recordList;
		} catch (Exception e) {

...
@SessionScoped
@Named("testModuleListManager")
public class ModuleListManager_Test extends AbstractDomainListManager<Module, ModuleListObject> implements Serializable {
	...
	protected Collection<Module> createRecordList() {
		try {
			Collection<Module> moduleList = moduleDataManager.getModuleList(ModuleType.TEST);
			if (moduleList != null)
				return moduleList;
			return recordList;
		} catch (Exception e) {

...
@SessionScoped
@Named("basicModuleListManager")
public class ModuleListManager_Basic extends AbstractDomainListManager<Module, ModuleListObject> implements Serializable {
	...
	protected Collection<Module> createRecordList() {
		try {
			Collection<Module> moduleList = moduleDataManager.getModuleList(ModuleType.BASIC);
			if (moduleList != null)
				return moduleList;
			return recordList;
		} catch (Exception e) {

...
@SessionScoped
@Named("serviceModuleListManager")
public class ModuleListManager_Service extends AbstractDomainListManager<Module, ModuleListObject> implements Serializable {
	...
	protected Collection<Module> createRecordList() {
		try {
			Collection<Module> moduleList = moduleDataManager.getModuleList(ModuleType.SERVICE);
			if (moduleList != null)
				return moduleList;
			return recordList;
		} catch (Exception e) {

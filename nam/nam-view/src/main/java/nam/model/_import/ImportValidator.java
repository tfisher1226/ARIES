...
@ApplicationScoped
@Named("importValidator")
public class ImportValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Import == false)
				throwError("Unexpected value: "+value);
			Import _import = (Import) value;
			if (ImportUtil.validate(_import) == false) {

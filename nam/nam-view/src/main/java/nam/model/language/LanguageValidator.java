...
@ApplicationScoped
@Named("languageValidator")
public class LanguageValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Language == false)
				throwError("Unexpected value: "+value);
			Language language = (Language) value;
			if (LanguageUtil.validate(language) == false) {

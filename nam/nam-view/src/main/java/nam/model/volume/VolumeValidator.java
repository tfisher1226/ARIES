...
@ApplicationScoped
@Named("volumeValidator")
public class VolumeValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Volume == false)
				throwError("Unexpected value: "+value);
			Volume volume = (Volume) value;
			if (VolumeUtil.validate(volume) == false) {

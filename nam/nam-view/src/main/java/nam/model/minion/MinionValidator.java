...
@ApplicationScoped
@Named("minionValidator")
public class MinionValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Minion == false)
				throwError("Unexpected value: "+value);
			Minion minion = (Minion) value;
			if (MinionUtil.validate(minion) == false) {

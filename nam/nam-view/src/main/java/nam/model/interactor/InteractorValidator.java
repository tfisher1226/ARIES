...
@ApplicationScoped
@Named("interactorValidator")
public class InteractorValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Interactor == false)
				throwError("Unexpected value: "+value);
			Interactor interactor = (Interactor) value;
			if (InteractorUtil.validate(interactor) == false) {

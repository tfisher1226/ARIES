...
@ApplicationScoped
@Named("transportValidator")
public class TransportValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Transport == false)
				throwError("Unexpected value: "+value);
			Transport transport = (Transport) value;
			if (TransportUtil.validate(transport) == false) {

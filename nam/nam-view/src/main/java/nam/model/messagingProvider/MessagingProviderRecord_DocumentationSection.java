...
@SessionScoped
@Named("messagingProviderDocumentationSection")
public class MessagingProviderRecord_DocumentationSection extends AbstractWizardPage<MessagingProvider> implements Serializable {
	
	private MessagingProvider messagingProvider;
	
	
	public MessagingProviderRecord_DocumentationSection() {

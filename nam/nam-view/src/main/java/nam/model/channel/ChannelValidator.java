...
@ApplicationScoped
@Named("channelValidator")
public class ChannelValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Channel == false)
				throwError("Unexpected value: "+value);
			Channel channel = (Channel) value;
			if (ChannelUtil.validate(channel) == false) {

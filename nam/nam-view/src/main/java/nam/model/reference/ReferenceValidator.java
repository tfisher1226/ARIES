...
@ApplicationScoped
@Named("referenceValidator")
public class ReferenceValidator extends AbstractValidator implements Validator, Serializable {
	...
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		...
		if (value != null) {
			...
			if (ReferenceUtil.validate(reference) == false) {

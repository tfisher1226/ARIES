...
@SessionScoped
@Named("processComponentListManager")
public class ComponentListManager_Process extends AbstractDomainListManager<Component, ComponentListObject> implements Serializable {
	...
	protected Collection<Component> createRecordList() {
		try {
			Collection<Component> componentList = componentDataManager.getComponentList("process");

...
@ApplicationScoped
@Named("componentValidator")
public class ComponentValidator extends AbstractValidator implements Validator, Serializable {
	...
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		...
		if (value != null) {
			...
			if (ComponentUtil.validate(component) == false) {

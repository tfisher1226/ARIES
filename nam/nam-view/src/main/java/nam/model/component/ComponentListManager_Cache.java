...
@SessionScoped
@Named("cacheComponentListManager")
public class ComponentListManager_Cache extends AbstractDomainListManager<Component, ComponentListObject> implements Serializable {
	...
	protected Collection<Component> createRecordList() {
		try {
			Collection<Component> componentList = componentDataManager.getComponentList("cache");

...
@SessionScoped
@Named("schedulerComponentListManager")
public class ComponentListManager_Scheduler extends AbstractDomainListManager<Component, ComponentListObject> implements Serializable {
	...
	protected Collection<Component> createRecordList() {
		try {
			Collection<Component> componentList = componentDataManager.getComponentList("scheduler");

...
@SessionScoped
@Named("componentListManager")
public class ComponentListManager extends AbstractDomainListManager<Component, ComponentListObject> implements Serializable {
	...
	protected Collection<Component> createRecordList() {
		try {
			Collection<Component> componentList = componentDataManager.getComponentList();

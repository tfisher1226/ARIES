...
@SessionScoped
@Named("basicComponentListManager")
public class ComponentListManager_Basic extends AbstractDomainListManager<Component, ComponentListObject> implements Serializable {
	...
	protected Collection<Component> createRecordList() {
		try {
			Collection<Component> componentList = componentDataManager.getComponentList("basic");

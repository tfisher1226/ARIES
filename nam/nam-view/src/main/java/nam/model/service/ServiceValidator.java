...
@ApplicationScoped
@Named("serviceValidator")
public class ServiceValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Service == false)
				throwError("Unexpected value: "+value);
			Service service = (Service) value;
			if (ServiceUtil.validate(service) == false) {

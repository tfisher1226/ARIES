...
@ApplicationScoped
@Named("annotationValidator")
public class AnnotationValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Annotation == false)
				throwError("Unexpected value: "+value);
			Annotation annotation = (Annotation) value;
			if (AnnotationUtil.validate(annotation) == false) {

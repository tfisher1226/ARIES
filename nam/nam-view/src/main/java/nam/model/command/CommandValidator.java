...
public class CommandValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Command == false)
				throwError("Unexpected value: "+value);
			Command command = (Command) value;
			if (CommandUtil.validate(command) == false) {

...
@ApplicationScoped
@Named("networkValidator")
public class NetworkValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Network == false)
				throwError("Unexpected value: "+value);
			Network network = (Network) value;
			if (NetworkUtil.validate(network) == false) {

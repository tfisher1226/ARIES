...
public class PersistenceValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Persistence == false)
				throwError("Unexpected value: "+value);
			Persistence persistence = (Persistence) value;
			if (PersistenceUtil.validate(persistence) == false) {

...
@ApplicationScoped
@Named("providerValidator")
public class ProviderValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Provider == false)
				throwError("Unexpected value: "+value);
			Provider provider = (Provider) value;
			if (ProviderUtil.validate(provider) == false) {

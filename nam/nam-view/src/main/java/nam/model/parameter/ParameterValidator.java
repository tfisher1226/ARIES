...
@ApplicationScoped
@Named("parameterValidator")
public class ParameterValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Parameter == false)
				throwError("Unexpected value: "+value);
			Parameter parameter = (Parameter) value;
			if (ParameterUtil.validate(parameter) == false) {

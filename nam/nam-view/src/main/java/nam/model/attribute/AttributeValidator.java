...
@ApplicationScoped
@Named("attributeValidator")
public class AttributeValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Attribute == false)
				throwError("Unexpected value: "+value);
			Attribute attribute = (Attribute) value;
			if (AttributeUtil.validate(attribute) == false) {

...
@ApplicationScoped
@Named("adapterValidator")
public class AdapterValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Adapter == false)
				throwError("Unexpected value: "+value);
			Adapter adapter = (Adapter) value;
			if (AdapterUtil.validate(adapter) == false) {

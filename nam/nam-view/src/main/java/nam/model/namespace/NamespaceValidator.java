...
@ApplicationScoped
@Named("namespaceValidator")
public class NamespaceValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Namespace == false)
				throwError("Unexpected value: "+value);
			Namespace namespace = (Namespace) value;
			if (NamespaceUtil.validate(namespace) == false) {

...
@ApplicationScoped
@Named("repositoryValidator")
public class RepositoryValidator extends AbstractValidator implements Validator, Serializable {
	...
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		...
		if (value != null) {
			...
			if (RepositoryUtil.validate(repository) == false) {

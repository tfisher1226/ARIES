...
@ApplicationScoped
@Named("invocationValidator")
public class InvocationValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Invocation == false)
				throwError("Unexpected value: "+value);
			Invocation invocation = (Invocation) value;
			if (InvocationUtil.validate(invocation) == false) {

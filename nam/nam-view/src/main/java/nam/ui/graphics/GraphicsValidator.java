...
@ApplicationScoped
@Named("graphicsValidator")
public class GraphicsValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Graphics == false)
				throwError("Unexpected value: "+value);
			Graphics graphics = (Graphics) value;
			if (GraphicsUtil.validate(graphics) == false) {

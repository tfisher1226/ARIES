...
@ApplicationScoped
@Named("conversationValidator")
public class ConversationValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Conversation == false)
				throwError("Unexpected value: "+value);
			Conversation conversation = (Conversation) value;
			if (ConversationUtil.validate(conversation) == false) {

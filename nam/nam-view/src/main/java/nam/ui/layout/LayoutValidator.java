...
@ApplicationScoped
@Named("layoutValidator")
public class LayoutValidator extends AbstractValidator implements Validator, Serializable {
	
	@Override
	public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
		resetState();
		if (value != null) {
			if (value instanceof Layout == false)
				throwError("Unexpected value: "+value);
			Layout layout = (Layout) value;
			if (LayoutUtil.validate(layout) == false) {

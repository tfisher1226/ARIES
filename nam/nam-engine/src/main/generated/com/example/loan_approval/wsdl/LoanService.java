...
public class LoanService extends Service {
    ...
    public final static QName SERVICE = new QName("http://example.com/loan-approval/wsdl", "loanService");
    public final static QName LoanServicePort = new QName("http://example.com/loan-approval/wsdl", "loanService_Port");
    static {
        URL url = null;
        try {
     ...
     * 
     * @return
     *     returns LoanServicePT
     */
    @WebEndpoint(name = "loanService_Port")
    public LoanServicePT getLoanServicePort() {
        return super.getPort(LoanServicePort, LoanServicePT.class);
    }
     ...
     */
    @WebEndpoint(name = "loanService_Port")
    public LoanServicePT getLoanServicePort(WebServiceFeature... features) {
        return super.getPort(LoanServicePort, LoanServicePT.class, features);
    }

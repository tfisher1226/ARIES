...
public class MapperBeanGeneratorOLD extends AbstractBeanGenerator {
	...
	protected void initializeClassAnnotations(ModelClass modelClass) throws Exception {
		...
		//classAnnotations.add(AnnotationUtil.createNameAnnotation(context.getElement().getType()));
		//classAnnotations.add(AnnotationUtil.createScopeAnnotation(ScopeType.STATELESS));
	}

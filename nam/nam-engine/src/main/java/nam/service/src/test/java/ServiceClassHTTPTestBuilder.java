...
public class ServiceClassHTTPTestBuilder extends AbstractBeanBuilder {
	...
	public ServiceClassHTTPTestBuilder(GenerationContext context) {
	...
	public ModelClass build(Service service) throws Exception {
		...
		String className = ServiceLayerHelper.getServiceInterfaceName(service) + "HTTPListenerTest";

 ...
 * @author tfisher
 */
public class ServiceManagerBuilder extends AbstractBeanBuilder {

	public ServiceManagerBuilder(GenerationContext context) {
		super(context);
	}
...
//			setClassName(service.getClassName());
	...
	public ModelAttribute createStateProcessorAttribute(Service service) {
		...
		String className = NameUtil.capName(service.getName()) + "Processor";

 ...
 * @author tfisher
 */
public class ServiceListenerForRMIUnitTestGenerator extends AbstractBeanGenerator {

	public ServiceListenerForRMIUnitTestGenerator(GenerationContext context) {

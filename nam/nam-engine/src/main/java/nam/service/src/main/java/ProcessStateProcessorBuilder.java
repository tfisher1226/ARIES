...
/**
 * Builds a Process State Processor {@link ModelClass} object given a {@link Process} Specification as input;
 * 
 ...
 * @author tfisher
 */
public class ProcessStateProcessorBuilder extends AbstractBeanBuilder {

	public ProcessStateProcessorBuilder(GenerationContext context) {
		super(context);
	}
	...
	public ModelClass build(Process process) throws Exception {
		...
		String className = ServiceLayerHelper.getProcessClassName(process) + "StateProcessor";
	...
	protected void initializeInstanceFields(ModelClass modelClass, Process process) throws Exception {
		...
		while (iterator.hasNext()) {
			...
			initializeInstanceFields(modelClass, process, cache);
		}
	}
	
	protected void initializeInstanceFields(ModelClass modelClass, Process process, Cache cache) throws Exception {
	...
	protected void initializeInstanceMethods(ModelClass modelClass, Process process) throws Exception {
		...
		createMethod_ValidateState(modelClass, process);
		createMethod_UpdateState(modelClass, process);
		createMethod_ProcessRequest(modelClass, process);
	}
	...
	protected void createMethod_ResetState(ModelClass modelClass, Process process) throws Exception {
		...
		ModelParameter modelParameter = CodeUtil.createParameter(rootName + "State", "state");
	...
	protected void createMethod_ValidateState(ModelClass modelClass, Process process) throws Exception {
		ModelOperation modelOperation = new ModelOperation();
	...
	protected void createMethod_ProcessRequest(ModelClass modelClass, Process process) throws Exception {
		ModelOperation modelOperation = new ModelOperation();

 ...
 * @author tfisher
 */
public class ServiceListenerForJAXWSUnitTestGenerator extends AbstractBeanGenerator {

	public ServiceListenerForJAXWSUnitTestGenerator(GenerationContext context) {

 ...
 * @author tfisher
 */
public class ServiceListenerForJMSUnitTestGenerator extends AbstractBeanGenerator {

	public ServiceListenerForJMSUnitTestGenerator(GenerationContext context) {

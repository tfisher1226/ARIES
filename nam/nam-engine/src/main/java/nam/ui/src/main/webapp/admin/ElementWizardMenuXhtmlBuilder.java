...
public class ElementWizardMenuXhtmlBuilder extends AbstractCompositionXHTMLBuilder {

	public ElementWizardMenuXhtmlBuilder(GenerationContext context) {
		super(context);
	}
	...
	public ModelFile buildElementFile(Information information, Element element) throws Exception {
		...
		String fileName = elementName + "WizardMenu.xhtml";

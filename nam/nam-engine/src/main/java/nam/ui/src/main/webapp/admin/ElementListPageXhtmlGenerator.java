...
public class ElementListPageXhtmlGenerator extends AbstractCompositionXHTMLGenerator {
	
	private ElementListPageXhtmlBuilder elementListPageXHTMLBuilder;
	
	
	public ElementListPageXhtmlGenerator(GenerationContext context) {
		super(context);
	}
	
	public void initialize(Project project, Module module) throws Exception {
		elementListPageXHTMLBuilder = new ElementListPageXhtmlBuilder(context);
	...
	public void generate(Information information, Element element) throws Exception {
		generateFile(elementListPageXHTMLBuilder.buildElementFile(information, element));
	}

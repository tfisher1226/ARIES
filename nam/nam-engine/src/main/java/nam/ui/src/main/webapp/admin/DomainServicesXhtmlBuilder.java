...
public class DomainServicesXhtmlBuilder extends AbstractCompositionXHTMLBuilder {

	public DomainServicesXhtmlBuilder(GenerationContext context) {
		super(context);
	}
	...
	public ModelFile buildFile(Information information) throws Exception {
		...
		String fileName = filePrefix + "ServicesPane.xhtml";
	...
	public String getFileContent(Information information) {
		...
		buf.putLine("						");
		buf.putLine("						<p>");
		buf.putLine("						The <b>"+domainName+"-service</b> module contains the following services.");
		buf.putLine("						</p>");
		buf.putLine("					</aries:text>");
		buf.putLine("					");
		...
		buf.putLine("							<aries:label type=\"H4\" value=\"Services\" />");
		...
		buf.putLine("						");
		buf.putLine("						<p>");
		buf.putLine("						The following protection mechanisms are configured for the <b>"+domainName+"-service</b> module.");
		buf.putLine("						</p>");
		buf.putLine("						<br/>");
		buf.putLine("					</aries:text>");
		buf.putLine("				</aries:panel>");

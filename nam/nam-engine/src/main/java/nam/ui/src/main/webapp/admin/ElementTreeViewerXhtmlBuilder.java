...
public class ElementTreeViewerXhtmlBuilder extends AbstractCompositionXHTMLBuilder {

	public ElementTreeViewerXhtmlBuilder(GenerationContext context) {
		super(context);
	}
	...
	public ModelFile buildElementFile(Information information, Element element) throws Exception {
		...
		String fileName = elementName + "TreeViewer.xhtml";
	...
	public String getElementFileContent(Element element) {
		...
		buf.putLine1("		id=\""+elementName+"TreeViewer\"");

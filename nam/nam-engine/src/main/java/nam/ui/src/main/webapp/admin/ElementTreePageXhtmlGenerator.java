...
public class ElementTreePageXhtmlGenerator extends AbstractCompositionXHTMLGenerator {
	
	private ElementTreePageXhtmlBuilder elementTreePageXHTMLBuilder;
	
	
	public ElementTreePageXhtmlGenerator(GenerationContext context) {
		super(context);
	}
	
	public void initialize(Project project, Module module) throws Exception {
		elementTreePageXHTMLBuilder = new ElementTreePageXhtmlBuilder(context);
	...
	public void generate(Information information, Element element) throws Exception {
		generateFile(elementTreePageXHTMLBuilder.buildElementFile(information, element));
	}

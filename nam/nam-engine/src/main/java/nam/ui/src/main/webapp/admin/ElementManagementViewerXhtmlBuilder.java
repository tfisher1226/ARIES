...
public class ElementManagementViewerXhtmlBuilder extends AbstractCompositionXHTMLBuilder {

	public ElementManagementViewerXhtmlBuilder(GenerationContext context) {
		super(context);
	}
	...
	public ModelFile buildElementFile(Information information, Element element) throws Exception {
		...
		String fileName = elementName + "ManagementViewer.xhtml";
	...
	public String getElementFileContent(Element element) {
		...
		buf.putLine1("		id=\""+elementName+"ManagementViewer\"");
		...
		buf.putLine1("			columnClasses=\"formColumnAlignLeft, formColumnAlignRight\"");
		buf.putLine1("			backgroundColor=\"inherit\">");
		buf.putLine1("			");
		buf.putLine1("			<aries:panel"); 
		buf.putLine1("				width=\"#{helper.wizard_middleSection_width - 20}\"");
		...
		buf.putLine1("				style=\"border-radius: 5px; border: 1px solid #{userSkin.borderColor}; background-color: white\">");
		buf.putLine1("				");
		buf.putLine1("				<!-- PANEL -->"); 
		...
		buf.putLine1("				<ui:param name=\"sectionFile\" value=\"#{sectionType}View_#{sectionName}Section.xhtml\" />");

...
public class ElementRecordNavigatorXhtmlGenerator extends AbstractCompositionXHTMLGenerator {
	
	private ElementRecordNavigatorXhtmlBuilder elementRecordNavigatorXHTMLBuilder;
	
	
	public ElementRecordNavigatorXhtmlGenerator(GenerationContext context) {
		super(context);
	}
	
	public void initialize(Project project, Module module) throws Exception {
		elementRecordNavigatorXHTMLBuilder = new ElementRecordNavigatorXhtmlBuilder(context);
...
//	}
	...
	public void generate(Information information, Element element) throws Exception {
		generateFile(elementRecordNavigatorXHTMLBuilder.buildElementFile(information, element));
	}

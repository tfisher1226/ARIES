...
public class ElementRecordMenuXhtmlGenerator extends AbstractCompositionXHTMLGenerator {
	
	private ElementRecordMenuXhtmlBuilder elementRecordMenuXHTMLBuilder;
	
	
	public ElementRecordMenuXhtmlGenerator(GenerationContext context) {
		super(context);
	}
	
	public void initialize(Project project, Module module) throws Exception {
		elementRecordMenuXHTMLBuilder = new ElementRecordMenuXhtmlBuilder(context);
	...
	public void generate(Information information, Element element) throws Exception {
		generateFile(elementRecordMenuXHTMLBuilder.buildElementFile(information, element));
	}

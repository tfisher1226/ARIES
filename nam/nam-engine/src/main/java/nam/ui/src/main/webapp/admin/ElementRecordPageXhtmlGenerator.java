...
public class ElementRecordPageXhtmlGenerator extends AbstractCompositionXHTMLGenerator {
	
	private ElementRecordPageXhtmlBuilder elementRecordPageXHTMLBuilder;
	
	
	public ElementRecordPageXhtmlGenerator(GenerationContext context) {
		super(context);
	}
	
	public void initialize(Project project, Module module) throws Exception {
		elementRecordPageXHTMLBuilder = new ElementRecordPageXhtmlBuilder(context);
	...
	public void generate(Information information, Element element) throws Exception {
		generateFile(elementRecordPageXHTMLBuilder.buildElementFile(information, element));
	}

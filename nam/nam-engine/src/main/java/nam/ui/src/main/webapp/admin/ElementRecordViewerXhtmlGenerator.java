...
public class ElementRecordViewerXhtmlGenerator extends AbstractCompositionXHTMLGenerator {
	
	private ElementRecordViewerXhtmlBuilder elementRecordViewerXHTMLBuilder;
	
	
	public ElementRecordViewerXhtmlGenerator(GenerationContext context) {
		super(context);
	}
	
	public void initialize(Project project, Module module) throws Exception {
		elementRecordViewerXHTMLBuilder = new ElementRecordViewerXhtmlBuilder(context);
...
//	}
	...
	public void generate(Information information, Element element) throws Exception {
		generateFile(elementRecordViewerXHTMLBuilder.buildElementFile(information, element));
	}

...
public class ElementManagementViewerXhtmlGenerator extends AbstractCompositionXHTMLGenerator {
	
	private ElementManagementViewerXhtmlBuilder elementManagementViewerXHTMLBuilder;
	
	
	public ElementManagementViewerXhtmlGenerator(GenerationContext context) {
		super(context);
	}
	
	public void initialize(Project project, Module module) throws Exception {
		elementManagementViewerXHTMLBuilder = new ElementManagementViewerXhtmlBuilder(context);
...
//	}
	...
	public void generate(Information information, Element element) throws Exception {
		generateFile(elementManagementViewerXHTMLBuilder.buildElementFile(information, element));
	}

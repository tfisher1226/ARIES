...
public class ElementTreeViewerXhtmlGenerator extends AbstractCompositionXHTMLGenerator {
	
	private ElementTreeViewerXhtmlBuilder elementTreeViewerXHTMLBuilder;
	
	
	public ElementTreeViewerXhtmlGenerator(GenerationContext context) {
		super(context);
	}
	
	public void initialize(Project project, Module module) throws Exception {
		elementTreeViewerXHTMLBuilder = new ElementTreeViewerXhtmlBuilder(context);
...
//	}
	...
	public void generate(Information information, Element element) throws Exception {
		generateFile(elementTreeViewerXHTMLBuilder.buildElementFile(information, element));
	}

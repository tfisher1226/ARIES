...
public class ElementTreeXhtmlGenerator extends AbstractCompositionXHTMLGenerator {
	
	private ElementTreeXhtmlBuilder elementTreeXHTMLBuilder;
	
	
	public ElementTreeXhtmlGenerator(GenerationContext context) {
		super(context);
	}
	
	public void initialize(Project project, Module module) throws Exception {
		elementTreeXHTMLBuilder = new ElementTreeXhtmlBuilder(context);
	...
	public void generate(Information information, Element element) throws Exception {
		generateFile(elementTreeXHTMLBuilder.buildElementFile(information, element));
	}

...
public class ElementManagementPageXhtmlGenerator extends AbstractCompositionXHTMLGenerator {
	
	private ElementManagementPageXhtmlBuilder elementManagementPageXHTMLBuilder;
	
	
	public ElementManagementPageXhtmlGenerator(GenerationContext context) {
		super(context);
	}
	
	public void initialize(Project project, Module module) throws Exception {
		elementManagementPageXHTMLBuilder = new ElementManagementPageXhtmlBuilder(context);
	...
	public void generate(Information information, Element element) throws Exception {
		generateFile(elementManagementPageXHTMLBuilder.buildElementFile(information, element));
	}

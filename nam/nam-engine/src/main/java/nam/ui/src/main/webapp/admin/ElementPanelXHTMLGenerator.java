...
public class ElementPanelXHTMLGenerator extends AbstractCompositionXHTMLGenerator {
	
	private ElementPanelXHTMLBuilder elementPanelXHTMLBuilder;
	
	
	public ElementPanelXHTMLGenerator(GenerationContext context) {
		super(context);
	}
	
	public void initialize(Project project, Module module) throws Exception {
		elementPanelXHTMLBuilder = new ElementPanelXHTMLBuilder(context);
	...
	public void generate(Information information, Element element) throws Exception {
		generateFile(elementPanelXHTMLBuilder.buildElementFile(information, element));
	}
	
	public void generate(Information information, Type type) throws Exception {
		generateFile(elementPanelXHTMLBuilder.buildTypeFile(information, type));
	}

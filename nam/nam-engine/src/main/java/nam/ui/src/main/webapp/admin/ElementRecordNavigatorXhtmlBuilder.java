...
public class ElementRecordNavigatorXhtmlBuilder extends AbstractCompositionXHTMLBuilder {

	public ElementRecordNavigatorXhtmlBuilder(GenerationContext context) {
		super(context);
	}
	...
	public ModelFile buildElementFile(Information information, Element element) throws Exception {
		...
		String fileName = elementName + "RecordNavigator.xhtml";

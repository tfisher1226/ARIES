...
public class ElementManagementNavigatorXhtmlGenerator extends AbstractCompositionXHTMLGenerator {
	
	private ElementManagementNavigatorXhtmlBuilder elementManagementNavigatorXHTMLBuilder;
	
	
	public ElementManagementNavigatorXhtmlGenerator(GenerationContext context) {
		super(context);
	}
	
	public void initialize(Project project, Module module) throws Exception {
		elementManagementNavigatorXHTMLBuilder = new ElementManagementNavigatorXhtmlBuilder(context);
...
//	}
	...
	public void generate(Information information, Element element) throws Exception {
		generateFile(elementManagementNavigatorXHTMLBuilder.buildElementFile(information, element));
	}

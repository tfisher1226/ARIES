...
public class ElementTreePageXhtmlBuilder extends AbstractCompositionXHTMLBuilder {

	public ElementTreePageXhtmlBuilder(GenerationContext context) {
		super(context);
	}
	...
	public ModelFile buildElementFile(Information information, Element element) throws Exception {
		...
		String fileName = elementName + "TreePage.xhtml";
	...
	public String getElementFileContent(Element element) {
		...
		buf.putLine1("	<ui:include src=\""+elementName+"TreeActions.xhtml\" />");
		...
		buf.putLine1("			<ui:param name=\"breadcrumbs\" value=\"#{"+elementName+"PageManager.getBreadcrumbs('"+elementName+"Tree')}\" />");
		buf.putLine1("		</ui:include>");
		buf.putLine1("	</span>");
		buf.putLine1("</ui:define>");
		buf.putLine1("");
		...
		buf.putLine1("	<div class=\"navigator\">");
		buf.putLine1("		<ui:include src=\""+elementName+"TreeNavigator.xhtml\" />");
		buf.putLine1("	</div>");
		buf.putLine1("</ui:define>");
		buf.putLine1("");
		...
		buf.putLine1("		id=\""+elementName+"TreeMessages\" ");
		buf.putLine1("		module=\""+elementName+"Tree\" ");
		buf.putLine1("		message=\"Enter #{"+elementName+"PageManager.sectionName} Information\" />");
		buf.putLine1("</ui:define>");
		buf.putLine1("");
		buf.putLine1("<!-- content -->");
		buf.putLine1("<ui:define name=\"content\">");
		buf.putLine1("	<div class=\"content\">");
		buf.putLine1("		<ui:include src=\""+elementName+"TreeViewer.xhtml\" />");
		buf.putLine1("	</div>");
		buf.putLine1("</ui:define>");
		return buf.get();
	}

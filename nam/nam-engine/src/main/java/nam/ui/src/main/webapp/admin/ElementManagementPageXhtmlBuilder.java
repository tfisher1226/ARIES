...
public class ElementManagementPageXhtmlBuilder extends AbstractCompositionXHTMLBuilder {

	public ElementManagementPageXhtmlBuilder(GenerationContext context) {
		super(context);
	}
	...
	public ModelFile buildElementFile(Information information, Element element) throws Exception {
		...
		String fileName = elementName + "ManagementPage.xhtml";

//		if (elementName.equalsIgnoreCase("project"))
//			System.out.println();
//		if (elementName.equalsIgnoreCase("userInterface"))
//			System.out.println();
	...
	public String getElementFileContent(Element element) {
		...
		buf.putLine1("			<ui:param name=\"breadcrumbs\" value=\"#{"+elementName+"PageManager.getBreadcrumbs('"+elementName+"Management')}\" />");
		buf.putLine1("		</ui:include>");
		buf.putLine1("	</span>");
		buf.putLine1("</ui:define>");
		buf.putLine1("");
		...
		buf.putLine1("		<ui:include src=\""+elementName+"ManagementNavigator.xhtml\" />");
		buf.putLine1("	</span>");
		buf.putLine1("</ui:define>");
		buf.putLine1("");
		...
		buf.putLine1("			<ui:param name=\"manager\" value=\"#{"+elementName+"PageManager}\" />");
		buf.putLine1("			<ui:param name=\"menu\" value=\"/"+elementPath+"/"+elementName+"/"+elementName+"RecordMenu.xhtml\" />");
		buf.putLine1("		</ui:include>");
        buf.putLine1("	</span>");
		buf.putLine1("</ui:define>");
		buf.putLine1("");
		...
		buf.putLine1("	<span class=\"sectionMessages\">");
		buf.putLine1("		<ui:include src=\"/common/sectionMessages.xhtml\">");
		buf.putLine1("			<ui:param name=\"domain\" value=\""+elementName+"Management\" />");
		buf.putLine1("			<ui:param name=\"message\" value=\""+elementClass+" Management Overview\" />");
		buf.putLine1("		</ui:include>");
		buf.putLine1("	</span>");
		buf.putLine1("</ui:define>");
		buf.putLine1("");
		...
		buf.putLine1("		<ui:include src=\""+elementName+"ManagementViewer.xhtml\" />");
		buf.putLine1("	</div>");
		buf.putLine1("</ui:define>");
		return buf.get();
	}

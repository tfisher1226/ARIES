...
public class ElementWizardMenuXhtmlGenerator extends AbstractCompositionXHTMLGenerator {
	
	private ElementWizardMenuXhtmlBuilder elementWizardMenuXHTMLBuilder;
	
	
	public ElementWizardMenuXhtmlGenerator(GenerationContext context) {
		super(context);
	}
	
	public void initialize(Project project, Module module) throws Exception {
		elementWizardMenuXHTMLBuilder = new ElementWizardMenuXhtmlBuilder(context);
	...
	public void generate(Information information, Element element) throws Exception {
		generateFile(elementWizardMenuXHTMLBuilder.buildElementFile(information, element));
	}

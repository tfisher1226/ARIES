 ...
 *         &lt;element ref="{http://nam/model}application" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "Group", namespace = "http://nam/model", propOrder = {
    "name",
    "participantName",
    "applications"
})
@XmlRootElement(name = "group", namespace = "http://nam/model")
public class Group
    implements Serializable
{
    ...
    @XmlElement(name = "application", namespace = "http://nam/model", required = true)

 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://nam/model}listener" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "Listeners", namespace = "http://nam/model", propOrder = {
    "listeners"
})
@XmlRootElement(name = "listeners", namespace = "http://nam/model")
public class Listeners implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "listener", namespace = "http://nam/model")

...
public class SkinUtil extends BaseUtil {
	
	public static Object getKey(Skin skin) {
		return skin.getName();
	}
	
	public static String getLabel(Skin skin) {
		return skin.getName();
	}
	...
	public static String toString(Skin skin) {
		if (isEmpty(skin))
			return "Skin: [uninitialized] "+skin.toString();
		String text = "";
		text += skin.getName();
		return text;
	}
	...
	public static void sortRecords(List<Skin> skinList) {
		Collections.sort(skinList, createSkinComparator());
	}
	
	public static Collection<Skin> sortRecords(Collection<Skin> skinCollection) {
		List<Skin> list = new ArrayList<Skin>(skinCollection);
		Collections.sort(list, createSkinComparator());
		return list;
	}
	...
	public static Comparator<Skin> createSkinComparator() {
		return new Comparator<Skin>() {
			public int compare(Skin skin1, Skin skin2) {
				Object key1 = getKey(skin1);
				Object key2 = getKey(skin2);

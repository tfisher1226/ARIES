...
@MessageDriven(name = "AdminRegistrationServiceListener", activationConfig = {
		@ActivationConfigProperty(propertyName = "clientId", propertyValue = "admin.registrationService"),
		@ActivationConfigProperty(propertyName = "destination", propertyValue = "java:/queue/admin_registration_service_queue"),
...
public class RegistrationServiceListenerForJMS extends AbstractJMSListener implements MessageListener {
